...
export default function AppPreviewRenderer({ schema }: AppPreviewRendererProps) {
  ...
  return (
    <>
      ...
      {/* Toast — fixed at viewport level (escapes overflow:hidden) */}
      {toast && (
        <div
          ...
          aria-live="polite"
        >
          <div className="bg-gray-900/90 backdrop-blur-sm text-white text-xs font-medium px-5 py-2.5 rounded-full shadow-xl whitespace-nowrap">
            {toast}
          </div>
        </div>
      )}
